...
//Clase encargada de generar reporte de los Registros a las entregas.
 ...
 * @author Tavo
 */
public class reporteRegistrarAEnt {
    ...
    public reporteRegistrarAEnt(String titulo, String nomPDF) {
        strRotuloPDF = titulo;
    ...
    public void agregarTabla(Paragraph parrafo) throws BadElementException {
        ...
        String rotulosColumnas[] = {"DESARROLLADOR", "PROYECTO", "ENTREGA", "ESTADO", "ROL"};
        ...
        PdfPCell cell = new PdfPCell(new Paragraph("DESARROLLADORES EN ENTREGAS"));
        cell.setColspan(5);
        ...
        try {
            if (!ejecucionBD.getConn().isClosed()) {
                ...
                strConsultaSQL = "select personal.nombre as \"DESARROLLADOR\", proyecto.titulo as \"PROYECTO\", entrega.titulo as \"ENTREGA\","
    ...
    public static void agregarMetaDatos(Document document) {
        document.addTitle("Documento con datos de tabla rolxent_per");
