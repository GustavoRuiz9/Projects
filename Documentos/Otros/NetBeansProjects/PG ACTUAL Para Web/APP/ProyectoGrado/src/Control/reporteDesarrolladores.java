 ...
 * @author Tavo
 */
public class reporteDesarrolladores {
    ...
    public reporteDesarrolladores(String titulo, String nomPDF) {
        strRotuloPDF = titulo;
    ...
    public void agregarTabla(Paragraph parrafo) throws BadElementException {
        ...
        float anchosFilas[] = {2f, 1f, 1.5f, 1f, 1f, 1f};
        PdfPTable tabla = new PdfPTable(anchosFilas);
        String rotulosColumnas[] = {"PROYECTO", "ENTREGA", "ACTIVIDAD", "ESTADO", "FECHA INICIO", "FECHA FIN"};
        ...
        try {
            if (!ejecucionBD.getConn().isClosed()) {
                ...
                strConsultaSQL = "select PROYECTO.titulo, ENTREGA.titulo , ACTIVIDAD.titulo, Actividad.estado, TO_CHAR(ACTIVIDAD.FECHA_INI,'dd/MM/yyyy'), TO_CHAR(ACTIVIDAD.FECHA_FIN,'dd/MM/yyyy')  from PROYECTO,ENTREGA,ACTIVIDAD,ROLxENT_PER\n"
