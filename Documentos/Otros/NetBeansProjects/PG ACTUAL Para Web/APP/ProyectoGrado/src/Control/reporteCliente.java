...
//Metodo encargado de generar reporte de los clientes.
import static Control.reporteDes.agregarLineasEnBlanco;
import static Control.reporteDes.agregarMetaDatos;
...
public class reporteCliente {
    ...
    public reporteCliente(String titulo, String nomPDF) {
        strRotuloPDF = titulo;
    ...
    public void agregarTabla(Paragraph parrafo) throws BadElementException {
        ...
        float anchosFilas[] = {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f};
        PdfPTable tabla = new PdfPTable(anchosFilas);
        String rotulosColumnas[] = {"CODIGO", "CEDULA", "NOMBRE", "APELLIDO", "SEXO", "CIUDAD", "TEL",
            "CORREO", "EMPRESA", "NIT EMPRESA"};
        ...
        try {
            if (!ejecucionBD.getConn().isClosed()) {
                ...
                strConsultaSQL = "Select codigo_cliente, cedula, nombre, apellido, sexo, ciudad.nombre_ciudad as \"CIUDAD\", "
                        + "telefono, correo, nom_empresa as \"EMPRESA\", nit_empresa as \"NIT\"\n"
                        + "from CIUDAD, CLIENTE where ciudad.codigo_ciudad = cliente.ciudad order by codigo_cliente";
                //ejecutar consulta
