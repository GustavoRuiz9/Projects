...
//Clase encargada de generar reporte de las Observaciones.
 ...
 * @author Tavo
 */
public class reporteObservaciones {
    ...
    public reporteObservaciones(String titulo, String nomPDF) {
        strRotuloPDF = titulo;
    ...
    public void agregarTabla(Paragraph parrafo) throws BadElementException {
        ...
        float anchosFilas[] = {1f, 4f, 1f};
        PdfPTable tabla = new PdfPTable(anchosFilas);
        String rotulosColumnas[] = {"PROYECTO", "DESCRIPCION", "VR_DEFINITIVO"};
        ...
        PdfPCell cell = new PdfPCell(new Paragraph("OBSERVACIONES"));
        cell.setColspan(13);
        ...
        try {
            if (!ejecucionBD.getConn().isClosed()) {
                ...
                strConsultaSQL = "select PROYECTO.titulo as \"proy\", DESCRIPCION as \"descripcion\",  vr_definitivo as \"definitivo\""
                        + " from observacion, proyecto where observacion.codigo_proy = proyecto.codigo_proy";
                //ejecutar consulta
