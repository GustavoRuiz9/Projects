...
//Metodo encargado de generar reporte de los Desarrolladores.
...
public class reporteDes {
    ...
    public reporteDes(String titulo, String nomPDF) {
        strRotuloPDF = titulo;
    ...
    public void agregarTabla(Paragraph parrafo) throws BadElementException {
        ...
        float anchosFilas[] = {1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f};
        PdfPTable tabla = new PdfPTable(anchosFilas);
        String rotulosColumnas[] = {"CODIGO", "CEDULA", "NOMBRE", "APELLIDO", "TEL", "CEL", "CORREO",
            "EDAD", "DIR", "CIUDAD", "CUENTA"};
        ...
        PdfPCell cell = new PdfPCell(new Paragraph("DESARROLLADORES"));
        cell.setColspan(13);
        ...
        try {
            if (!ejecucionBD.getConn().isClosed()) {
                ...
                strConsultaSQL = "select codigo_personal, cedula,nombre, apellido,telefono,celular, correo, edad, direccion, "
                        + "CIUDAD.nombre_ciudad as \"ciudad\", cuenta_activa as cuenta_sesion \n"
                        + "from personal, ciudad where \n"
                        + "personal.codigo_ciudad = ciudad.codigo_ciudad and not codigo_personal = 1 order by codigo_personal";
                //ejecutar consulta
