...
//Metodo encargado de generar reporte de las Entregas.
...
public class reporteEntrega {
    ...
    public reporteEntrega(String titulo, String nomPDF) {
        strRotuloPDF = titulo;
    ...
    public void agregarTabla(Paragraph parrafo) throws BadElementException {
        ...
        String rotulosColumnas[] = {"ENTREGA", "TITULO", "PROYECTO", "PORCENTAJE", "INICIO", "FIN",
            "FIN REAL", "ESTADO", "VALOR"};
        ...
        PdfPCell cell = new PdfPCell(new Paragraph("ENTREGAS"));
        cell.setColspan(13);
        ...
        try {
            if (!ejecucionBD.getConn().isClosed()) {
                ...
                strConsultaSQL = "select codigo_entrega as \"CODIGO\", entrega.titulo, proyecto.titulo as \"PROYECTO\", "
                        + "porcentaje, to_char(entrega.FECHA_INICIO,'dd/MM/yyyy') as \"INICIO\", "
                        + "to_char(entrega.fecha_fin,'dd/MM/yyyy') as \"FIN\", "
                        + "to_char(entrega.fecha_fin_real, 'dd/MM/yyyy') as \"FIN REAL\", "
                        + "entrega.estado, entrega.valor from entrega, proyecto where \n"
                        + "proyecto.codigo_proy = entrega.proyecto order by entrega.proyecto, entrega.codigo_entrega";
                //ejecutar consulta
